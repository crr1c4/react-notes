...
const NoteCreator = (props) => {
  ...
  return (
    <div className="text-black dark:text-white min-h-full flex flex-col justify-center items-center select-none gap-5">
      ...
      <div className="rounded-xl bg-gray-100 dark:bg-gray-800 p-2 w-3/4 lg:w-2/4 flex flex-row items-center">
      ...
      <div className="rounded-xl bg-gray-100 dark:bg-gray-800 p-2 h-60 w-3/4 lg:w-2/4 flex flex-row items-center">
        <textarea
      ...
      <div className="w-3/4 lg:w-2/4 grid grid-rows-3 sm:grid-rows-2 lg:grid-rows-none lg:grid-cols-2 gap-3">
        <button
